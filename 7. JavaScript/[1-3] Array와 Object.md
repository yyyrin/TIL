...
- 개요
    - JavaScript의 데이터 타입 중 참조 타입(reference)에 해당 하는 타입은 **Array**와 **Object**이며, 객체라고도 함
...
2. [참고] Django로 보는 콜백함수 예시
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/4ef93ec4-cf2b-4e8f-acd9-72542b1b6ee6/Untitled.png)
...
6. Array Helper Methods - reduce
    ...
    - reduce 동작 방식
        ...
        ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c0ed4b56-fd10-40ef-9512-10aa9b2b37ed/Untitled.png)
...
10. 배열 순회 비교
    ...
    - break, continue 사용 불가능 | Airbnb Style Guide
    권장 방식 |
...
6. Spread syntax (…)
    - 배열과 마찬가지로 전개구문을 사용해 객체 내부에서 객체 전개 가능ㄴ
    - 얕은 복사에 활용 가능
