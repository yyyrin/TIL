...
2. HTTP 특징
    - **Stateless (무상태)**<br>
        ...
        - 동일한 연결(connection)에서 연속적으로 수행되는 두 요청 사이에 링크가 없음<br>
...
3. HTTP Request Methods
    - 리소스에 대한 행위(수행하고자 하는 동작)을 정의<br>
...
1. API
    ...
    - API는 복잡한 코드를 추상화하여 대신 사용할 수 있는 몇 가지 더 쉬운 구문을 제공
        - 예를 들어 집의 가전 제품에 전기를 공급해야 한다고 가정해보자.<br>
...
3. [참고] Open API
    - 개발자라면 누구나 사용할 수 있도록 공개된 API<br>
...
5. REST에서 자원을 정의하고 주소를 지정하는 방법
    ...
    - 자원의 행위
        - HTTP Method
    - 자원의 표현
        - 자원과 행위를 통해 궁극적으로 표현되는 (추상화된) 결과물<br>

        - JSON으로 표현된 데이터를 제공
<br><br><br>

6. JSON
    - JSON is lightweight data-interchange format<br>
